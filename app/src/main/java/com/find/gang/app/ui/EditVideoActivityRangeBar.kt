...
import com.find.gang.app.databinding.ActivityBarVideoBinding
...
class EditVideoActivityRangeBar : AppCompatActivity(), OnRangeChangeListener {
    private lateinit var binding: ActivityBarVideoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBarVideoBinding.inflate(layoutInflater)
            ...
            mainHandler.post {
                ...
                if (success) {
                    if (overwrite) {
                        ...
                        Toast.makeText(
                            this@EditVideoActivityRangeBar,
                            "新视频已保存: $dstPath",
                            Toast.LENGTH_LONG
                        ).show()
                        // 可选择打开新视频预览
                    ...
                    Toast.makeText(this@EditVideoActivityRangeBar, "裁剪失败", Toast.LENGTH_SHORT).show()
                }
            }
        }.start()
    }
