package com.example.myapplication.torrent.activities
...
import com.example.myapplication.torrent.fragments.TorrentFragment
import com.gang.lib.torrent.TorrentSessionOptions
import com.gang.lib.torrent.extensions.appCompatRequestPermissions
import com.gang.lib.torrent.extensions.isPermissionGranted
...
class TorrentActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun startActivity(activity: Activity){
            val intent: Intent = Intent(activity, TorrentActivity::class.java)
